          ...
          <div className="log-header">
            <div>
              ...
              <p className="log-subtitle">
                Add the Qada prayers you have completed.
              </p>
            </div>
            ...
            <div className="log-banner">
              ...
              <div className="banner-text">
                <p className="banner-main">
                  Every prayer you log brings you closer.
                </p>
            ...
            {prayers.map((p) => (
              <div className="prayer-row" key={p.name}>
                ...
                <div className="prayer-row-info">
                  ...
                  <span className="prayer-row-remaining">
          ...
          <div className="log-summary-card">
            ...
            <div className="summary-col">
              ...
              <div>
                ...
                <p className="summary-col-value large">
                  {afterUpdate.toLocaleString()}
                </p>
